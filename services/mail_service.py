...
def send_verification_email(email, code):
    ...
    In development, it prints to console if SMTP is not configured.
    """
    subject = "Verify your MBSTU CP Ranking Account"
...
def send_reset_password_email(email, code):
    ...
    """
    subject = "Reset your MBSTU CP Ranking Password"
...
def _send_mail(to_email, subject, body):
    ...
    print(f"DEBUG: Attempting to send mail. Server: {smtp_server}, Port: {smtp_port}, User: {smtp_user}")
